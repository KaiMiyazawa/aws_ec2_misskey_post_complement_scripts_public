...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--complement-bucket", default="miyazawa1s3-complement", help="補完結果を保存するバケット")
    parser.add_argument("--complement-prefix", default="misskey/complement", help="補完結果のプレフィックス")
